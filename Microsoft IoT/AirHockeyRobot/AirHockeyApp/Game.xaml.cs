   ...
   /*     private void runFourPointTest()
        {
            ...
            {
                robot.MoveToOffset(new Point(Config.MAX_MALLET_OFFSET_X, 0));
                robot.RunToPosition();

                robot.MoveToOffset(new Point(Config.MAX_MALLET_OFFSET_X, Config.MAX_MALLET_OFFSET_Y));
                robot.RunToPosition();

                robot.MoveToOffset(new Point(0, Config.MAX_MALLET_OFFSET_Y));
                robot.RunToPosition();
