...
namespace AirHockeyApp
{
    ...
    {
        Straight,   // Move to destination in straight line
    ...
    public class AIHelper
    {
        ...
        /// <summary>
        /// Determine where to move the mallet, based on the puck's current position
        /// </summary>
...
/*
        ...
        public class CenterOfMass
        {
            ...
            /// <summary>
            /// Calculates the center of mass of all the points in the PointQueue
            /// </summary>
            /// <returns>Center of mass point</returns>
